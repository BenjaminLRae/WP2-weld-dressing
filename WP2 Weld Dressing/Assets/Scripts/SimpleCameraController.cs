...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        public float elevationClampLower = -45f;
        public float elevationClampHigher = 10f;
        ...
        void Update()
        {
            ...
            if (IsSelectedMouseButtonDown())
            {
                Cursor.lockState = CursorLockMode.Locked;
            }

            // Unlock and show cursor when right mouse button released
            if (IsSelectedMouseButtonUp())
            {
                Cursor.visible = true;
            ...
            if (IsCameraRotationAllowed())
            {
                ...
                m_TargetCameraState.pitch = Mathf.Clamp(m_TargetCameraState.pitch, elevationClampLower, elevationClampHigher);

                //Debug.Log("Yaw: " + m_TargetCameraState.yaw + ", Pitch:" + m_TargetCameraState.pitch);
            }
        ...
        bool IsSelectedMouseButtonDown()
        {
#if ENABLE_INPUT_SYSTEM
